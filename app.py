...
os.system(f"sed -i -e '/demo:/r /home/xlab-app-center/header.py' /home/xlab-app-center/ai_brush_art/modules/ui.py")
os.system(f"sed -i -e '253,258d' /home/xlab-app-center/ai_brush_art/modules/ui_settings.py")
os.system(f"sed -i -e '186,228d' /home/xlab-app-center/ai_brush_art/modules/ui_settings.py")
os.system(f"sed -i -e '171,178d' /home/xlab-app-center/ai_brush_art/modules/ui_settings.py")
os.system(f"sed -i -e '108,113d' /home/xlab-app-center/ai_brush_art/modules/ui_settings.py")
os.system(f"sed -i -e '225,227d' /home/xlab-app-center/ai_brush_art/modules/ui_loadsave.py")
os.system(f"sed -i -e '214,217d' /home/xlab-app-center/ai_brush_art/modules/ui_loadsave.py")
os.system(f"aria2c --console-log-level=error -c -x 16 -s 16 -k 1M https://civitai.com/api/download/models/71392 -d /home/xlab-app-center/ai_brush_art/models/Stable-diffusion -o chilloutworld_v15.safetensors")
